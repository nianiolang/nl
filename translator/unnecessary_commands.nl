...
def build_commands_graph(state : @unnecessary_commands::state_t, blocks : @flow_graph::blocks_t, all_commands_num : ptd::sim())
		: @unnecessary_commands::graph_t {
...
def build_block_state(ref state : @unnecessary_commands::state_t, blocks : @flow_graph::blocks_t,
		block_nr : ptd::sim(), entrance_state : @unnecessary_commands::block_state_t, ref visited_blocks : ptd::hash(ptd::sim())) {
	var change = false;

...
def check_module(module : @nast::module_t, ref def_fun : @tc_types::defs_funs_t, ref errors : @
	...
	var modules : @tc_types::modules_t = {env=>{deref=>deref, current_module => module->name, breaks => {vars=>{}, is=>false}, ret_type=>tct::empty()}, imports => {}, funs => def_fun};
...
def set_end_function(ref vars : @tc_types::vars_t) : ptd::void() {
	hash::set_value(ref vars, '__END', {overwrited => :yes,type => tct::empty()});
}
...
def check_fora(as_fora : @nast::fora_t, ref modules : @tc_types::modules_t, ref vars : @tc_types::vars_t, ref 
	...
	add_error(ref errors, 'fora argument should be an array instead of '.get_print_tct_type_name(fora_arr_type->type))
		unless
		ptd_system::is_accepted(fora_arr_type, tct::arr(tct::tct_im()), ref modules, ref errors);
...
def check_rep(as_rep : @nast::rep_t, ref modules : @tc_types::modules_t, ref vars : @tc_types::vars_t, ref 
	...
	add_error(ref errors, 'rep argument should be a number instead of '.get_print_tct_type_name(count_type->type))
		unless
		ptd_system::is_accepted(count_type, tct::sim(), ref modules, ref errors);
	var vars_op : @tc_types::vars_t = vars;
...
def get_special_functions() : @tc_types::special_functions {
	...
	hash::set_value(ref f,'array::push',{r=>tct::void(), a=>[
	...
	hash::set_value(ref f,'array::join',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::sim(), name=>''},
			{mod=>:none,  type=>tct::arr(tct::sim()), name=>''},
		]});
	hash::set_value(ref f,'array::append',{r=>tct::void(), a=>[
			{mod=>:ref,  type=>tct::arr(tct::tct_im()), name=>''},
			{mod=>:none,  type=>tct::arr(tct::tct_im()), name=>''},
		]});
	hash::set_value(ref f,'array::len',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::arr(tct::tct_im()), name=>''},
		]});
	
	hash::set_value(ref f,'hash::set_value',{r=>tct::void(), a=>[
	...
	hash::set_value(ref f,'hash::get_value',{r=>tct::tct_im(), a=>[
		...
		{mod=>:none, type=>tct::sim(), name=>''}]});
	hash::set_value(ref f,'hash::has_key',{r=>tct::bool(), a=>[
		{mod=>:none, type=>tct::hash(tct::tct_im()), name=>''},
		{mod=>:none, type=>tct::sim(), name=>''}]});
	hash::set_value(ref f,'hash::delete',{r=>tct::void(), a=>[
		{mod=>:ref, type=>tct::hash(tct::tct_im()), name=>''},
		{mod=>:none, type=>tct::sim(), name=>''}]});
	hash::set_value(ref f,'hash::size',{r=>tct::sim(), a=>[
		{mod=>:none, type=>tct::hash(tct::tct_im()), name=>''}]});
	hash::set_value(ref f,'hash::values',{r=>tct::arr(tct::tct_im()), a=>[
		{mod=>:none, type=>tct::hash(tct::tct_im()), name=>''}]});

	hash::set_value(ref f,'ov::is',{r=>tct::bool(), a=>[
			{mod=>:none,  type=>tct::var({}), name=>''},
			{mod=>:none,  type=>tct::sim(), name=>''},
		]});
	...
	hash::set_value(ref f,'dfile::ssave',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::tct_im(), name=>''},
		]});
		
	hash::set_value(ref f,'string::lf',{r=>tct::sim(), a=>[]});
	hash::set_value(ref f,'string::length',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::sim(), name=>''},
		]});
	hash::set_value(ref f,'string::substr',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::sim(), name=>''},
			{mod=>:none,  type=>tct::sim(), name=>''},
			{mod=>:none,  type=>tct::sim(), name=>''},
		]});
	hash::set_value(ref f,'string::replace',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::sim(), name=>''},
			{mod=>:none,  type=>tct::sim(), name=>''},
			{mod=>:none,  type=>tct::sim(), name=>''},
		]});
	hash::set_value(ref f,'string::chr',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::sim(), name=>''},
		]});
	hash::set_value(ref f,'string::ord',{r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::sim(), name=>''},
		]});
	hash::set_value(ref f,'string::split',{r=>tct::arr(tct::sim()), a=>[
			{mod=>:none,  type=>tct::sim(), name=>''},
			{mod=>:none,  type=>tct::sim(), name=>''},
		]});
	hash::set_value(ref f, 'c_std_lib::fast_substr', {r=>tct::sim(), a=>[
			{mod=>:none,  type=>tct::tct_im(), name=>''},
			{mod=>:none,  type=>tct::tct_im(), name=>''},
			{mod=>:none,  type=>tct::tct_im(), name=>''},
		]});
...
def check_special_function(ret_type : @tc_types::type, fun_val : @nast::fun_val_t, fun_val_type : ptd::arr(@tc_types::type),
	...
	if (name eq 'array::push') {
		...
		set_type_to_lval_spec(fun_val->args[0]->val, fun_val_type[0], fun_val_type[1], 
			tct::arr(tct::empty()), ref modules, ref vars, ref errors);
	}
	...
	if (name eq 'hash::set_value') {
		...
		set_type_to_lval_spec(fun_val->args[0]->val, fun_val_type[0], fun_val_type[2], 
			tct::rec({}), ref modules, ref vars, ref errors);
	}
...
def check_var_decl_try(var_decl : @nast::variable_declaration_t, is_try : @boolean_t::type, ref modules : @
	...
	var var_type : @tct::meta_type = tct::empty();

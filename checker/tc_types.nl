...
def get_binary_ops() : ptd::hash(@tc_types::bin_op_type) {
	...
	op_def(ref ret, 'lt', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, 'gt', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, 'le', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, 'ge', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, '<=', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, '<', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, '>', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, '==', tct::sim(), tct::sim(), tct::bool());
	...
	op_def(ref ret, 'cmp', tct::sim(), tct::sim(), tct::bool());
	op_def(ref ret, '&', tct::sim(), tct::sim(), tct::sim());
	op_def(ref ret, '|', tct::sim(), tct::sim(), tct::sim());
	op_def(ref ret, '^', tct::sim(), tct::sim(), tct::sim());
